...
// Sanjar _CNN_ <cnnsanj@mail.ru> уБОДЦБТ
...
$zdes_raspolojeno = "Bu yerda Нахуй (Qo'toq)ning rasmiy ofisi joylashgan. Odatda bu yerga yuborishadi.";

$chto_eto_znachit = "Bu nima degani?";
$vas_poslali = "Agar siz bu sahifaga kelib qolgan b'lsangiz, bu faqat bir narsani anglatadi: sizni Нахуй ga (Qo'toqqa) yuborishdi, aniqrog'i sizga: \"Пошел нахуй\" deyishdi. Qo'pol bo'lsada, juda chiroyli: bu saytni adresi orqali.";
...
$est_variant = "Bundan tashqari siz bilmasdan (behosdan) bu saytga kelib qolgan bolishingiz mumkin, masalan internetda qidiryapganda. Ammo, baribir siz o'zingizni hayotingiz haqida oylab ko'ring, ahir sizga hatto internet ham \"Пошел нахуй\" deyapti.";
...
Shuni bilingki: Har gal kimnidir qo'toqqa (Нахуйga) yuborilganda, qo'toqning Rasmiy markazda past ovozli ho'rsinish yuz beradi. Biz sizning barcha qiliqlaringiz haqida habardormiz. Нахуй (Qo'toq) sizni sevadi!!!";
...
##
Internet Explorerning настройки menusiga kirib buni o'ziz qiling.
...
//обихкga hat yozay! - (оБРЙУБФШ РЙУШНП оБИХК)
